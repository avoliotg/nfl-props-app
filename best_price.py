...
def load(args):
    ...
    if args.books:
        ...
        print(f"\n  book filter: {raw['book'].nunique()} of {before} books kept")

    props = eh.collapse_books(raw)
...
def main():
    ...
    ap.add_argument("--books", default=None,
                    help="restrict the menu to these books, comma separated")
    ...
    print("=" * 96)
    print("BEST AVAILABLE PRICE across all books")
    print("=" * 96)
