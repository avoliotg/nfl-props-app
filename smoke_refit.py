"""
Synthetic smoke test for sigma_refit.
...
print(f"PLANTED sigma is 0.88 x shipped with var/mean NOT constant; a\nrefit form should beat shipped on log loss in every season.")
print("#" * 96)
print()

sys.argv = ["sigma_refit", "--all-seasons"]
importlib.import_module("sigma_refit").main()
