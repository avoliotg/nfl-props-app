...
def main():
    ...
    print("=" * 96)
    print("EDGE THRESHOLD v2: where a shrunk edge clears the vig")
    ...
    slevel = None
    if args.sigma_mode == "level" or args.sigma_scan:
    ...
    s = price(joined, params, args.line_source, slevel, args.sigma_mode,
              args.sigma_scale)
